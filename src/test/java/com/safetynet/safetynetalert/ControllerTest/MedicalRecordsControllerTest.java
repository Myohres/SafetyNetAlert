...
public class MedicalRecordsControllerTest {
    ...
    public void testGetMedicalRecordById() throws Exception {
        mockMvc.perform(get("/medical_records/id/1"))
                .andExpect(status().isOk());
    }
    ...
    public void testGetMedicalRecordByPerson() throws Exception {
        mockMvc.perform(get("/medical_records/lastname/Boyd/firstname/John"))
                .andExpect(status().isOk());
    }
    ...
    public void testAddMedicalRecord() throws Exception {
        mockMvc.perform(post("/medical_records/")
    ...
    public void testReplaceMedicalRecord() throws Exception {
        mockMvc.perform(put("/medical_records/1")
                .contentType(MediaType.APPLICATION_JSON).content("{}"))
                .andExpect(status().isOk());
    }
    ...
    public void testAddMedication() throws Exception {
        mockMvc.perform(put("/medical_records/id/1/medication/medication test"))
                .andExpect(status().isOk());
    }
    ...
    public void testAddAllergy() throws Exception {
        mockMvc.perform(put("/medical_records/id/1/allergy/test allergy"))
                .andExpect(status().isOk());
    }
    ...
    public void testDelMedicalRecordById() throws Exception {
        mockMvc.perform(delete("/medical_records/2"))
                .andExpect(status().isOk());
    }
    ...
    public void testDelMedicalRecordById_ShouldReturnNotFound() throws Exception {
        ...
        mockMvc.perform(delete("/medical_records/1"))
                .andExpect(status().isNotFound());
    }

    @Test
    public void testDelMedicalRecordByName() throws Exception {
        mockMvc.perform(delete("/medical_records/lastname/Boyd/firstname/John"))
                .andExpect(status().isOk());
    }
    ...
    public void testDelOneMedication() throws Exception {
        mockMvc.perform(delete("/medical_records/id/1/medication/hydrapermazol:100mg"))
                .andExpect(status().isOk());
    }
    ...
    public void testDelOneAllergy() throws Exception {
        mockMvc.perform(delete("/medical_records/id/1/allergy/nillacilan"))
                .andExpect(status().isOk());
    }
    ...
    public void testClearMedications() throws Exception {
        mockMvc.perform(delete("/medical_records/id/1/medications"))
                .andExpect(status().isOk());
    }
    ...
    public void testClearAllergies() throws Exception {
        mockMvc.perform(delete("/medical_records/id/1/allergies"))
                .andExpect(status().isOk());
    }
