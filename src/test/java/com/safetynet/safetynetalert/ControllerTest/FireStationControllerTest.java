...
public class FireStationControllerTest {
    ...
    public void testGetStationByAddress() throws Exception {
        ...
        mockMvc.perform(get("/fireStation/address?address=25 rue auge"))
        .andExpect(status().isOk());
    }
    ...
    public void testAddStation() throws Exception {
        mockMvc.perform(post("/fireStation/station")
    ...
    public void testAddAddress() throws Exception {
        mockMvc.perform(post("/fireStation/id/1/address?address=221B Baker Street"))
                .andExpect(status().isOk());
    }
    ...
    public void testMoveAddressStation() throws Exception {
        mockMvc.perform(put("/fireStation/oldId/1/newId/6/address?address=908 73rd St"))
                .andExpect(status().isOk());
    }
    ...
    public void testMoveAddressStation_ShouldReturnNotFound() throws Exception {
        ...
        mockMvc.perform(put("/fireStation/oldId/1/newId/2/address?address=25 rue auge"))
                .andExpect(status().isNotFound());
    }

    @Test
    public void testChangeStationNumber() throws Exception {
        mockMvc.perform(put("/fireStation/oldId/4/newId/2"))
                .andExpect(status().isOk());
    }
    ...
    public void testChangeStation_ShouldReturnNotFound() throws Exception {
        ...
        mockMvc.perform(put("/fireStation/oldId/3/newId/7"))
                .andExpect(status().isNotFound());
    }
    ...
    public void testDeleteAddressStation() throws Exception {
        ...
        mockMvc.perform(delete("/fireStation/id/1/address?address=644 Gershwin Cir"))
                .andExpect(status().isOk());
    }
    ...
    public void testDeleteAllAddressStation() throws Exception {
        mockMvc.perform(delete("/fireStation/id/1/addresses"))
                .andExpect(status().isOk());
    }
